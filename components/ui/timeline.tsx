  ...
  return (
    <div className="w-full bg-background font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto pt-20 pb-8 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-6xl mb-4 text-foreground max-w-4xl font-bold">
          Event&apos;s Timeline
        </h2>
        <p className="text-muted-foreground text-2xl md:text-base max-w-sm">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-20 md:gap-10">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-border border border-ring p-2" />
              </div>
