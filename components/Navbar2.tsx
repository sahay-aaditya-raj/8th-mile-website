...
export default function Navbar() {
    ...
    return (
        <>
            {/* Desktop Navigation */}
            <div className="absolute p-3 px-8 w-full mx-auto hidden md:block text-white z-50">
            ...
            <div className="md:hidden absolute left-1/2 transform -translate-x-1/2 z-[9999] w-[100%]">
