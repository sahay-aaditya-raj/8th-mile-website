  ...
  return (
    <>
      <div className="w-full hidden md:block">
        ...
        {/* Section 3.5 */}
        <section className="sticky bg-[#15714c] mb-[500px] top-0 green-grid-bg flex flex-col items-center justify-center text-4xl font-bold h-screen">
          ...
          <div className="flex justify-between relative fit-content">
            <div className="relative bottom-10">
              ...
              <div className="absolute bottom-[100px] left-[100px] sora text-center text-black z-20">
                VASUKI<br /> VAIBHAV
              </div>
            </div>
            <div className="relative bottom-10">
              ...
              <div className="absolute bottom-[100px] left-[120px]  sora text-center text-black z-20">
                VDJ<br /> SHAAN
              </div>
            </div>
            <div className="relative bottom-10">
    ...
    "
      ...
      <div className="w-full md:hidden">
        ...
        {/* Section 3.5 */}
        <section className="sticky h-[4700px] bg-[#15714c]  top-0 green-grid-bg justify-center flex text-4xl font-bold">
          <div className="text-white text-[80px] sora font-extrabold top-8 mx-auto absolute tracking-tight">
            PRO<span className="seasons">NITES</span>
          </div>


          <div className="flex flex-col overflow-y-auto  fit-content mt-[8rem]">
