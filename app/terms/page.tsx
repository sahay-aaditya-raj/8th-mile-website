        ...
        <Card className="bg-[#0a0a0a] border border-gray-700 shadow-lg mb-8">
          <CardContent className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#f9dd9c] mb-2">6. Intellectual Property</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-[#f9dd9c] mb-2">7. Privacy</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-[#f9dd9c] mb-2">8. Limitation of Liability</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-[#f9dd9c] mb-2">9. Governing Law</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-[#f9dd9c] mb-2">10. Amendments</h2>
